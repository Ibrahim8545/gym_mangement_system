...
namespace gym_management_system.Models
{
    ...
    {
        private int id, numOfClass, numOfInvatation;
        private string name, status;
        private MonthOfferModel monthOffer;

        public PackgeModel(int id = 0, int numOfClass = 0, int numOfInvatation = 0, string name = null, string status = null, MonthOfferModel monthOffer = null)
        {
            Id = id;
